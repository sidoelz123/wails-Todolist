<template>
  ...
  >
    ...
    <button
      ...
      type="submit"
      class="absolute right-2 top-1/2 z-50 flex size-8 -translate-y-1/2 items-center justify-center rounded-full bg-black transition duration-200 disabled:bg-gray-100 disabled:cursor-not-allowed dark:bg-zinc-900 dark:disabled:bg-zinc-700"
    >
      <svg
